...
import os, sys
import numpy as np
from EEG_feature_extraction_realtime import generate_feature_vectors_from_samples


def gen_training_matrix(full_matrix, cols_to_ignore):
    """
    ...
    #         state = 1.
    #     elif state.lower() == 'relaxed' or state.lower() == 'wandering':
    #         state = 0.
    #     else:
    #         print ('Wrong file name', x)
    #         sys.exit(-1)
